...
**Upcoming score windows:** EXP-010 → 2026-07-31 (extended) · EXP-016 → ship after EXP-010 concludes (2026-07-31) · EXP-017 → 2026-08-04 · EXP-018 → queue after EXP-016. **Recently concluded: EXP-015 WIN +200% (2026-07-29 — top-of-page CTA on headless: 0.29→0.86 GH clicks/day, 5 named events). EXP-012 inconclusive (2026-07-28). EXP-014 inconclusive (2026-07-27). EXP-001/002/003 inconclusive (2026-07-26). EXP-005 inconclusive, EXP-011 win +12.3% (2026-07-25). EXP-004/009 no_effect (2026-07-24).**
...
- **Page:** /guides/ai-agent-orchestration-2026/ and /guides/ai-agent-sandboxing/ (first two targets)
- **KPI:** GitHub stars (PostHog autocapture + custom event `exp018_guide_topofpage_cta_click`)
- **Status:** `queued`
- **Implementation idea:** Same compact green/teal banner as EXP-015, placed immediately after the subtitle paragraph on each page. Customize copy to the guide: orchestration guide → "amux is the open-source control plane for AI agent orchestration — run a fleet of Claude Code, Codex, or Gemini CLI sessions from one dashboard."; sandboxing guide → "amux gives each agent its own isolated tmux session with configurable filesystem access — security built in, not bolted on."
- **Effort:** XS per page (2 files)
- **Ship when:** After EXP-016 ships (2026-07-31) to avoid overlapping homepage + guide experiments
